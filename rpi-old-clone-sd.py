#!/bin/bash
# From https://learn.adafruit.com/adafruit-raspberry-pi-lesson-1-preparing-and-sd-card-for-your-raspberry-pi/make-a-backup-image
# This only works with occidentalis 0.2 and older versions of Raspbian 
# Run with this command:
#     sudo python rpi-old-clone-sd.py
...
# Abort if not running under sudo:
if [ `id -u` != 0 ]
then
